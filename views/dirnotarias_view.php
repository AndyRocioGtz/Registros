    ...
    <div class="col-sm-9 text-left">
      ...
      <tbody>
        <tr>
          ...
          <td>En el actuar de los servidores públicos..</td>
        </tr>
        <tr>
          <td><strong>Justicia:</strong></td>
          <td>Para garantizar la Seguridad Jurídica y la legalidad de los servicios. </td>
        </tr>
        <tr>
          <td><strong>Responsabilidad:</strong></td>
          <td> En el cumplimiento del compromiso.</td>
        </tr>
        <tr>
          <td><strong>Integridad:</strong></td>
          <td>En el actuar de sus Servidores Públicos.</td>
        </tr>
        <tr>
          <td><strong>Solidadridad:</strong></td>
          <td>Con las demandas del usuario.</td>
        </tr>
        <tr>
          <td><strong>Congruencia:</strong></td>
          <td>Entre el decir y el actuar.</td>
        </tr>
      </tbody>
    </table>
    </div>
